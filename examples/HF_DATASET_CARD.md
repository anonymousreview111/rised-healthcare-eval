...
the [`rised`](https://github.com/anonymousreview111/rised-healthcare-eval) Python
...
| License | MIT |
| Source code | [github.com/anonymousreview111/rised-healthcare-eval](https://github.com/anonymousreview111/rised-healthcare-eval) |
...
import pandas as pd
df = pd.read_csv(
    "hf://datasets/anonymousreview111/rised-healthcare-eval-dataset/synthetic_cohort_10k.csv"
)
```
...
Anonymous Author — `anonymous@example.com` — ORCID:
[]()
