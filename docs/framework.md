...
<!-- Full mathematical specification populated in Sessions 2–3. -->
...
grounded in the published evaluation, fairness, and calibration literature.

## Dimension 1: Reliability

*Stub — Session 2 will populate the formal specification.*
...
*Stub — Session 3 will populate the formal specification.*
