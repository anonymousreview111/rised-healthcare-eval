...
[![Dataset on HuggingFace](https://img.shields.io/badge/%F0%9F%A4%97%20Dataset-rised--healthcare--eval--dataset-yellow)](https://huggingface.co/datasets/anonymousreview111/rised-healthcare-eval-dataset)
...
```bash
git clone https://github.com/anonymousreview111/rised-healthcare-eval.git
...
🤗 **[anonymousreview111/rised-healthcare-eval-dataset](https://huggingface.co/datasets/anonymousreview111/rised-healthcare-eval-dataset)**

```python
from datasets import load_dataset
ds = load_dataset("anonymousreview111/rised-healthcare-eval-dataset")
...
stage.** See the [HuggingFace dataset card](https://huggingface.co/datasets/anonymousreview111/rised-healthcare-eval-dataset)
...
@article{anonymous2026rised,
  ...
  year    = {2026},
  note    = {Under review},
  url     = {https://github.com/anonymousreview111/rised-healthcare-eval}
}
```
